    ...
    <div className={styles.cartpage}>
      ...
      >
        <img
          ...
          src="/react-app_phone-catalog/img/icons/icon-chevron-arrow-left.png"
          alt=""
        />
      ...
      {cart.length === 0 ? (
        <div className={styles.cartpage__noproducts}>
          ...
          <img
            src="/react-app_phone-catalog/img/cart-is-empty.png"
            alt="image"
            ...
            {cart.map(product => (
              ...
              >
                <div className={styles.cartpage__section}>
                  <img
                    src="/react-app_phone-catalog/img/icons/icon-close.png"
                    alt="image"
                    className={styles.cartpage__closebut}
                    onClick={() => removeProduct(product.product)}
                  />
                  <img
                    src={'/react-app_phone-catalog/' + product.product.image}
                    alt="image"
                ...
                <div className={styles.cartpage__section_2}>
                  <div className={styles.cartpage__changequantity}>
                    ...
                    >
                      <img
                        src="/react-app_phone-catalog/img/icons/icon-minus.png"
                        alt="image minus"
                    ...
                    >
                      <img
                        src="/react-app_phone-catalog/img/icons/icon-plus.png"
                        alt="image plus"
                        className={styles.cartpage__changequantity_but_img}
                      />
                    </button>
