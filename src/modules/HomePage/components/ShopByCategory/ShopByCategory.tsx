  ...
  return (
    <div className={styles.shopbycategory}>
      ...
      <div className={styles.shopbycategory__categories}>
        ...
        >
          <img
            src="/react-app_phone-catalog/pictures/shop-by-category--phones.png"
            alt="Phones"
        ...
        >
          <img
            src="/react-app_phone-catalog/pictures/shop-by-category--tablets.png"
            alt="Tablets"
            className={styles.shopbycategory__category_card__image}
          />
          <h4 className={styles.shopbycategory__category_card__title}>
        ...
        >
          <img
            ...
            src="/react-app_phone-catalog/pictures/shop-by-category--accessories.png"
            alt="Accessories"
            className={styles.shopbycategory__category_card__image}
          />
          <h4 className={styles.shopbycategory__category_card__title}>
