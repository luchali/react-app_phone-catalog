...
const favoriteIcons = '/react-app_phone-catalog/img/icons/';
      ...
      {product ? (
          ...
          <div className={styles.productdetailspage__gallery}>
            <div className={styles.productdetailspage__gallery__thumbs}>
              {images.map((image: string) => (
                ...
                >
                  <img
                    src={`/react-app_phone-catalog/${image}`}
                    alt={product.name}
            ...
            >
              <img
                src={`/react-app_phone-catalog/${activeImage}`}
                alt={product.name}
        ...
        <div className={styles.notfoundproductpage}>
          ...
          <img
            ...
            src="/react-app_phone-catalog/img/page-not-found.png"
            alt="Page Not Found"
          />
        </div>
      )}
